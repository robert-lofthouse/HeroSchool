...
namespace HeroSchoolUI
{
    public sealed class Battles
    {
        ...
        public void AddBattleForm(frmBattle p_frmbattle)
        {
            _battleforms.Add(p_frmbattle);
        }
